    ...
    return (
        <>
            ...
            <div className="flex flex-row space-x-5 px-20 pt-5 pb-10">
                <div className="bg-white rounded-lg border-2 border-[#f0f0f0] px-8 py-4 max-w-md w-full">
                    <div className="flex items-center justify-between mb-4">
                        <img className="h-12" src="td.svg" alt="TD Logo" />
                    ...
                    <div className="bg-white rounded-lg border-2 border-[#f0f0f0] px-8 py-4 flex-1">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <div className="bg-[#73AAE8] rounded-full px-4 py-1 flex items-center" style={{ backgroundColor: 'rgba(115, 170, 232, 0.3)' }}>
                                <h1 className="text-[#578BC7] text-[12px] font-spaceGrotesk">$500 CAD</h1>
                            </div>
                        </div>
                    ...
                    <div className="bg-white rounded-lg border-2 border-[#f0f0f0] px-8 py-4 flex-1">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <div className="bg-[#73AAE8] rounded-full px-4 py-1 flex items-center" style={{ backgroundColor: 'rgba(115, 170, 232, 0.3)' }}>
                                <h1 className="text-[#578BC7] text-[12px] font-spaceGrotesk">$2,000 CAD</h1>
                            </div>
                        </div>
                    ...
                    <div className="bg-white rounded-lg border-2 border-[#f0f0f0] px-8 py-4 flex-1">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <div className="bg-[#73AAE8] rounded-full px-4 py-1 flex items-center" style={{ backgroundColor: 'rgba(115, 170, 232, 0.3)' }}>
                                <h1 className="text-[#578BC7] text-[12px] font-spaceGrotesk">$1,000 CAD</h1>
                            </div>
                        </div>
                        <h1 className="text-[#101827] text-[20px] font-spaceGrotesk font-bold whitespace-nowrap">Interior Savings Scholarship</h1>
                        <h1 className="text-[#808080] text-[13px]">Due on May 29th • Canada</h1>
                    </div>
            </div>
        </>
    );
